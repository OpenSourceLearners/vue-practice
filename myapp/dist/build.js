...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(9), __webpack_require__(53)))
...
var _fastclick = __webpack_require__(109);
...
var _qs = __webpack_require__(106);
...
function post(url, params) {
    ...
    return new _promise2.default(function (resolve, reject) {
        _axios2.default.post(url, { params: params }).then(function (_ref2) {
            var data = _ref2.data;
...
var App = function App(resolve) {
    return __webpack_require__.e/* require */(2).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(120)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
};
...
var myRouter = new _vueRouter2.default({
    routes: [{
        path: '/',
        component: App,
        children: [{ path: '/home', component: home }, { path: '/login', component: login }, { path: '*', redirect: '/home' }]
    }]
});
...
var _getters = __webpack_require__(115);
